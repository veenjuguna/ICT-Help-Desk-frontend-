...
export default function LoginPage() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Small delay to let the HttpOnly cookie settle
  ...
  if (checking) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-[#FDF8F2]">
        <div className="text-[#6B2D0F] text-lg">Checking session...</div>
      </div>
    );
  }
      ...
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .bg-overlay {
          position: absolute;
          inset: 0;
          background: linear-gradient(to bottom, rgba(74,30,10,0.3) 0%, rgba(74,30,10,0.6) 50%, rgba(74,30,10,0.92) 100%);
          z-index: 1;
        }
        .left-content {
          position: relative;
